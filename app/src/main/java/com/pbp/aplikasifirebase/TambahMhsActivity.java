package com.pbp.aplikasifirebase;
...
public class TambahMhsActivity extends AppCompatActivity {
    ...
    private void insertData() {
        ...
        database = FirebaseDatabase.getInstance("https://praktikum-firebase-8705f-default-rtdb.asia-southeast1.firebasedatabase.app/");
